    ...
    <div class="s1-U__width--900px s1-U__pd16" style="margin: 0 auto;">
      ...
      <section class="s1-U__mg--bt32">
        ...
        <div class="s1-U__pd--lt16 s1-U__pd--rt16">
          <div v-if="Package.Form.Services.length === 0">
            ...
            <md-button class="md-primary md-raised" @click="Package.ServicesDialog = true">
              <div class="s1-U__align-children--center s1-U__pd--rt8 s1-U__pd--lt4">
                <md-icon class="s1-U__mg--rt4">add</md-icon>
                <span>Serviço</span>
              </div>
          ...
          <div v-else>
            <div class="s1-U__width--240px">
              ...
              >
                <span>{{getNameById(Services, service)}}</span>
                <span class="md-caption">{{formatMoney(getPropById(Services, service, 'Value'))}}</span>
              </div>
            </div>
            <md-button
              class="md-primary s1-md-bordered"
              @click="Package.ServicesDialog = true"
            >Editar serviços</md-button>
          </div>
        </div>
      </section>
      <md-dialog
      ...
      >
        ...
        <div class="s1-U__align-children--stretch s1-U__full-height s1-U__bg-color--body-bg">
          <div class="s1-U__bg-color--white s1-U__width--210px s1-U__flex-shrink-0">
            <md-list class="s1-U__pd0">
              <md-list-item
                ...
                @click="Package.ActiveCategory = type.Id; closeAndCleanDetails()"
          ...
          <div
            class="s1-U__full-height s1-U__full-width s1-U__align-children--center s1-U__bg-color--body-bg"
          >
            <md-content
              ...
              >
                ...
                >
                  ...
                  <div class="s1-U__text-align--right s1-U__align-children--center">
                    ...
                    >{{service.Id === Package.DetailedService.Id ? 'fechar detalhes' : 'detalhes'}}</md-button>
                    <md-button
                    ...
                    >
                      <md-icon>{{!hasIncluded(service.Id) ? 'check_box_outline_blank' : 'check_box'}}</md-icon>
                    </md-button>
                  </div>
                </div>
              </md-card>
